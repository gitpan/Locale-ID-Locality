...
This document describes version 0.05 of Locale::ID::Locality (from Perl distribution Locale-ID-Locality), released on 2014-07-22.
...
=item * B<bps_prov_code.in> => I<array>
...
=item * B<bps_prov_code.not_in> => I<array>
...
=item * B<fields> => I<array> (default: "ind_name")
...
Source repository is at L<https://github.com/sharyanto/perl-Locale-ID-Locality>.
